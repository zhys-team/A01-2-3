...
public class CheckSample {
    ...
    public static void main2(String[] args) {
        ...
        // 初始化biz_content
        CheckSample.Biz_content biz_content = checkSample.new Biz_content(fphm,fpdm,kprq,fpje,jym);
        // 初始化originData
        CheckSample.OriginData originData = checkSample.new OriginData(appId,sign_type,JSONObject.toJSONString(biz_content),version);
        // 生成签名
    ...
    public static String submitCheck(CheckSample.OriginData originData){
        //result 为请求返回结果
        String result= "";
        try {
    ...
    public static String getMD5Sign(CheckSample.OriginData originData){
