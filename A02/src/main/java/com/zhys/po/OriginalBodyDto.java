...
@Getter
@Setter
@ApiModel(value = "OriginalBodyDto", description = "")
@XmlAccessorType(XmlAccessType.FIELD)
public class OriginalBodyDto implements IPO {
    private static final long serialVersionUID = 1L;

    @ApiModelProperty(value = "单据编码", name = "docOrignum")
    @XmlElement(name = "docOrignum")
    private String docOrignum;

    @ApiModelProperty(value = "行号", name = "docOrigline")
//  @EntityValidate(allowEmpty = false)
    @ExcelCell(name = "行号")
    @XmlElement(name = "docOrigline")
    private String docOrigline;

    @ApiModelProperty(value = "开票产品名称 ", name = "itemNum")
    @EntityValidate(allowEmpty = false)
    @ExcelCell(name = "开票产品编号")
    ...
    @ApiModelProperty(value = "开票计量ID ", name = "unitCode")
